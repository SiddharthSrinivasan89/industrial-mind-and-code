...
## V2a Results — sarvam-30b (10 runs, context only) — superseded by V2d; canonical values in section below
...
*These figures used the llama.cpp default top_p=0.95 (not explicitly set). They are retained for traceability but superseded by the V2d runs below, which use the GGUF-documented top_p=1.0.*
...
**Finding:** sarvam-30b and gpt-oss:120b show no practically meaningful difference in the tested context conditions (OVAR difference = 0.019). India's sovereign model does not produce meaningfully different ordering behaviour on this task. Neither model approaches the heuristic baseline.
