"""
Local inference backend for V6 StatelessSwing.

Targets any OpenAI-compatible endpoint (Ollama, vLLM, LM Studio).

Public interface:
  get_alpha_decision() — called by agent_interface.get_alpha_value()
...
def get_alpha_decision(
    ...
    """Call local endpoint and return alpha selection + telemetry."""
    ...
    try:
        ...
        raise RuntimeError(f"Missing or invalid alpha field — {ctx}") from exc
